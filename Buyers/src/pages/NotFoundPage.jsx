      ...
      <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12 pt-32 md:pt-0">
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex items-center mt-6 gap-x-3">
            ...
            <Link
              to="/"
              className="text-white bg-orange-500 cursor-pointer hover:bg-orange-600 duration-200 rounded-md sm:text-sm sm:py-3 sm:px-4 px-2 text-center dark:hover:bg-gray-300 dark:hover:text-gray-900"
            >
              Take me home
            </Link>
          </div>
        ...
        <div className="relative w-full mt-8 lg:w-1/2 lg:mt-0">
          <Player src={err} className="player" loop autoplay />
        </div>
      </div>
    </section>
  );
